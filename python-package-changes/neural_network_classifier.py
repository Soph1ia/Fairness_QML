...
from ..objective_functions import (
    ...
    ObjectiveFunction,
    FairnessObjectiveFunction, ## New code here
)
...
class NeuralNetworkClassifier(TrainableModel, ClassifierMixin):
    ...
    def __init__(
        ...
        one_hot: bool = False,
        fairness: bool = False, ## New code here
        ...
        Args:
            ...
            fairness: New code added to use fairness as an objective function ## New code here
        ...
        self.fairness = fairness ## New code here
    ...
    def _create_objective(self, X: np.ndarray, y: np.ndarray, traindata) -> ObjectiveFunction:
        """
        ...
        # >>>>>>>>>>>>>>>>>>>>> maybe here we can add fairness? <<<<<<<<<<<<<<<<<<<<
        if self._neural_network.output_shape == (1,):
            ...
            if self._one_hot:
                ...
                function = FairnessObjectiveFunction(X, y, self._neural_network, self._loss, traindata) ## New code here
            else:
